...
hardwarefile = "hardware2.py"

def choose_letters():
    a0 = "!#$%&'()*+,-./0123456789:;<=>?"
    # Not including "\", '"' as these create problems.
    ...
    a14 = "\u16a0\u16a2\u16a6\u16a8\u16ac\u16b1\u16b2\u16b4\u16b7\u16b9\u16ba\u16bc\u16be\u16c1\u16c3\u16c5\u16c7\u16c8\u16c9\u16ca\u16cb\u16cf\u16d2\u16d6\u16d7\u16d8\u16da\u16dc\u16de\u16df\u16e6\u16eb\u16ec\u16ed\u16ee\u16ef\u16f0"
    ...
    russian = a11 + a13
    runes = a14
    return asciiChars + latin + nordic + greek + russian + runes
...
if len(alphabet) % 2 != 0:
    print("Error: alphabet has to have an even length, "
          +f"{len(alphabet)} is not ok.")
    sys.exit()
...
with open(hardwarefile, "w", encoding="utf-8") as out:
    ...
    out.write("\n\n")
    out.write("rotors = ")
    out.write(f"{genereate_rotors(alphabet=alphabet, start=10, stop=60)}")
